...
ReactDOM.render(
    <div style={{ display: "inline-block" }}>
        ...
        <div style={{ float: "left", padding: "10px 20px 0 0" }}><a style={{textDecoration: "none", color: "black"}} href="/points.html"><LandingCard cardName="View Points" imgsrc={PointsIcon}/></a></div>
